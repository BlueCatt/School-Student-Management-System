 ...
 * @author ylyu
 */
public class goMyMessage extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setCharacterEncoding("utf-8");;
                        ...
                        ArrayList getAl=cs.showMyMessage(id);
                        ArrayList sendAl=cs.showMySendMessage(id);
                        
                      
                        request.setAttribute("myMessage", getAl);
                        request.setAttribute("mySendMessage", sendAl);
