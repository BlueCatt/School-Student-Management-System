<%-- 
    Document   : showSearchedFriends
    Created on : Mar 24, 2015, 7:30:10 PM
    Author     : painter
--%>
...
<html>
    ...
    <body>
         <%
                ...
                <h2>Here are Friends you are looking for:</h2>
                
               
                    
                <%
            
            ArrayList al=(ArrayList)request.getAttribute("SearchedFriends");
